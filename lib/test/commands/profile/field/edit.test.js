...
describe('profile:field:edit', () => {
    ...
    test('renames existing field in profile', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    test('changes existing field permissions in profile', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        expect(fs.existsSync(testProjectName)).toBe(true);
