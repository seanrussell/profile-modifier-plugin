...
class Edit extends command_1.SfdxCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const filesModified = yield edit_1.editInProfiles(util_1.getFileNames(directories, profiles, this.project['path']), name, rename, enabled, '', 'page', alphabetize);
            this.ux.stopSpinner('Done');
            this.ux.styledHeader('Pages edited in profiles');
            this.ux.table(util_1.getDataForDisplay(filesModified, this.project['path'].length, 'edit', 'page'), ['Action', 'MetadataType', 'ProjectFile']);
            return {};
        });
    }
}
