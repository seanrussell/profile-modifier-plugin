...
class Add extends command_1.SfdxCommand {
    run() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const filesModified = yield add_1.addToProfiles(util_1.getFileNames(directories, profiles, this.project['path']), names, enabled, '', 'class', alphabetize);
            this.ux.stopSpinner('Done');
            this.ux.styledHeader('Classes added to profiles');
            this.ux.table(util_1.getDataForDisplay(filesModified, this.project['path'].length, 'add', 'class'), ['Action', 'MetadataType', 'ProjectFile']);
            return {};
        });
    }
}
