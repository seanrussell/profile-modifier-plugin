...
export default class Delete extends SfdxCommand {
  ...
  public async run(): Promise<AnyJson> {
    ...
    if (profiles) {
      profilesModified = removeFromProfiles(directory, getProfiles(profiles), names, 'page');
    } else {
      profilesModified = removeFromProfiles(directory, readFiles(directory), names, 'page');
    }
